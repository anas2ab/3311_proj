...
extern void F977_16501(EIF_REFERENCE, int);
extern void EIF_Minit977(void);
extern EIF_REFERENCE _A1111_35_2();
...
#define ui4_1 ui4_1x.it_i4
	...
	RTLXI(loc1);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6241, 0xF80003D7, 0); /* model */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6241, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6246, 0xF800040F, 0); /* sys */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6246, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6249, 0xF8000411, 0); /* ui */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6249, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 6247, 0xF8000447, 0); /* input */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6247, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 6248, 0xF8000456, 0); /* output */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6248, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTNHOOK(7,2);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFFF9,1,186,0xFF01,1110,0xFFFF};
		EIF_TYPE typres0;
	...
	*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr5= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1111_35_2, (EIF_POINTER)(0),7216, tr3, 0, 1, -1, tr1, 1);
	}
	ur1 = RTCCL(tr5);
		...
		*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
		...
		if (tb1) {
			...
			*(EIF_REFERENCE *)(Current + RTWA(6243, dtype)) = (EIF_REFERENCE) tr1;
			...
			RTNHOOK(13,1);
			ur1 = RTCCL(arg1);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(6786, "execute_without_log", tr1))(tr1, ur1x);
			RTHOOK(14);
			RTDBGAA(Current, dtype, 6242, 0x04000000, 1); /* error */
			*(EIF_BOOLEAN *)(Current + RTWA(6242, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
			RTHOOK(15);
...
void F977_16501 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 976, Current, 0, 16500);
	RTSA(dtype);
	RTME(dtype, 0);
