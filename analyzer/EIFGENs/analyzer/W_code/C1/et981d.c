...
static const EIF_TYPE_INDEX egt_1_981 [] = {0xFF01,248,980,0xFFFF};
...
static const EIF_TYPE_INDEX egt_13_981 [] = {0xFF01,1330,0xFFFF};
...
static const struct desc_info desc_981[] = {
	...
	{EIF_GENERIC(egt_13_981), 14870, 0},
};
void Init981(void)
{
	IDSC(desc_981, 0, 980);
	IDSC(desc_981 + 1, 1, 980);
	IDSC(desc_981 + 32, 386, 980);
}
