...
extern EIF_TYPED_VALUE F980_8929(EIF_REFERENCE);
extern EIF_TYPED_VALUE F980_8930(EIF_REFERENCE);
extern EIF_TYPED_VALUE F980_8931(EIF_REFERENCE);
extern EIF_TYPED_VALUE F980_8932(EIF_REFERENCE);
extern EIF_TYPED_VALUE F980_8933(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F980_8934(EIF_REFERENCE);
...
RTOID (F980_8929)
EIF_TYPED_VALUE F980_8929 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 979, Current, 3, 0, 15230);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 15230);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F980_8930)
EIF_TYPED_VALUE F980_8930 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 979, Current, 2, 0, 15231);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 15231);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(2, 0xF80000E8, 0, 0); /* loc2 */
...
RTOID (F980_8931)
EIF_TYPED_VALUE F980_8931 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 979, Current, 1, 0, 15232);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 15232);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F980_8932 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 15233);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 15233);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F980_8933 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 979, Current, 1, 1, 15234);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 15234);
...
body:;
	...
	RTNHOOK(2,1);
	ur1 = RTCCL(arg1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2846, "item", tr1))(tr1, ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	loc1 = RTCCL(tr2);
	if (EIF_TEST(loc1)) {
		RTHOOK(3);
		RTDBGAL(0, 0xF80000E8, 0,0); /* Result */
...
RTOID (F980_8934)
EIF_TYPED_VALUE F980_8934 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 15235);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 15235);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (8929,F980_8929)
	RTOTS (8930,F980_8930)
	RTOTS (8931,F980_8931)
	RTOTS (8934,F980_8934)
}
