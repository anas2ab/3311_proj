...
extern void F1266_13025(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ETF_TUPLE_ARG}.make */
void F1266_13025 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1265, Current, 0, 1, 19267);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	*(EIF_REFERENCE *)(Current + RTWA(10698, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10727, 0xF80000F8, 0); /* value */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1265, Current, 1, 0, 19269);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
