...
extern EIF_TYPED_VALUE F1270_10939(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1270_10939 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1269, Current, 0, 0, 17605);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1269, Current, 17605);
	RTIV(Current, RTAL);
	RTHOOK(1);
