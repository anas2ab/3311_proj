...
extern EIF_TYPED_VALUE F1297_11323(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1297_11324(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1297_11326(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1297_11327(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1297_11328(EIF_REFERENCE);
extern void F1297_16538(EIF_REFERENCE, int);
...
/* {EV_RADIO_PEER}.peers */
EIF_TYPED_VALUE F1297_11323 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1296, Current, 0, 0, 17987);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1296, Current, 17987);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1297_11324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1296, Current, 0, 0, 17988);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1296, Current, 17988);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1297_11326 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1296, Current, 1, 0, 17989);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1296, Current, 17989);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		RTNHOOK(4,1);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8702, "is_selected", tr1))(tr1)).it_b);
		if (tb2) {
			RTHOOK(5);
...
EIF_TYPED_VALUE F1297_11327 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1296, Current, 0, 0, 17990);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1296, Current, 17990);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1297_11328 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1297_16538 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1296, Current, 0, 16537);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	if (tb2) {
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8703, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8703, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		tb1 = !RTCEQ(tr1, tr2);
	}
	if (tb1) {
		RTCK;
