...
extern EIF_TYPED_VALUE F1305_13424(EIF_REFERENCE);
...
RTOID (F1305_13424)
EIF_TYPED_VALUE F1305_13424 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1304, Current, 0, 0, 19653);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1304, Current, 19653);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
