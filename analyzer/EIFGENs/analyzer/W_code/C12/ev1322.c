...
extern EIF_TYPED_VALUE F1322_11679(EIF_REFERENCE);
extern void F1322_11680(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1322_11679 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1322_11680 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1321, Current, 0, 0, 18346);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1321, Current, 18346);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8445, 0xF80005B5, 0); /* implementation */
