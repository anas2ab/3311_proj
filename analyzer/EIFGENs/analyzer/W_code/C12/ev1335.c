...
extern EIF_TYPED_VALUE F1335_11925(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1335_11925 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1334, Current, 0, 0, 18592);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1334, Current, 18592);
	RTIV(Current, RTAL);
	RTHOOK(1);
