...
extern EIF_TYPED_VALUE F1336_11926(EIF_REFERENCE);
extern void F1336_11927(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1336_11926 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1336_11927 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1335, Current, 0, 0, 18594);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1335, Current, 18594);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8414, 0xF80005CA, 0); /* implementation */
