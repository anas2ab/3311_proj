...
extern EIF_TYPED_VALUE F1342_11957(EIF_REFERENCE);
extern void F1342_11958(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1342_11957 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1342_11958 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1341, Current, 0, 0, 18625);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1341, Current, 18625);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8445, 0xF80005D0, 0); /* implementation */
