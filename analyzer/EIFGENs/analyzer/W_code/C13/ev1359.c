...
extern EIF_TYPED_VALUE F1359_12110(EIF_REFERENCE);
extern void F1359_12111(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1359_12110 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1359_12111 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1358, Current, 0, 0, 18778);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1358, Current, 18778);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8445, 0xF80005F8, 0); /* implementation */
