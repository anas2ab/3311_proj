...
extern EIF_TYPED_VALUE F1370_12235(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1370_12236(EIF_REFERENCE);
extern void F1370_12237(EIF_REFERENCE);
extern void F1370_12238(EIF_REFERENCE);
...
/* {EV_MENU_BAR}.parent */
EIF_TYPED_VALUE F1370_12235 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 18907);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	RTNHOOK(2,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(10062, "parent", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
void F1370_12237 (EIF_REFERENCE Current)
{
	GTCX
...
void F1370_12238 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8413, 0xF8000580, 0); /* implementation */
