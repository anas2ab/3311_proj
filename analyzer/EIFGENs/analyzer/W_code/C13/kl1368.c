...
extern EIF_TYPED_VALUE F1368_14366(EIF_REFERENCE);
...
RTOID (F1368_14366)
EIF_TYPED_VALUE F1368_14366 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1367, Current, 0, 0, 20891);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1367, Current, 20891);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
