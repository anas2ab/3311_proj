...
static EIF_TYPED_VALUE F1396_12675_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1396_12675(EIF_REFERENCE);
extern void F1396_16568(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1396_12675_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1395, Current, 0, 0, 19231);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1395, Current, 19231);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1396_12675 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9374, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1396_12675_body (Current)).it_r;
...
void F1396_16568 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1395, Current, 0, 16567);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("not_has_text_implies_text_empty", Current);
	tb1 = '\01';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9636, dtype))(Current)).it_b);
	if ((EIF_BOOLEAN) !tb2) {
