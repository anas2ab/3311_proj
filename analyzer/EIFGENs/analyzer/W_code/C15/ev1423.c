...
extern EIF_TYPED_VALUE F1423_13255(EIF_REFERENCE);
extern void F1423_13256(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1423_13259(EIF_REFERENCE);
static EIF_TYPED_VALUE F1423_13260_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1423_13260(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1423_13255 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1422, Current, 3, 0, 19716);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1422, Current, 19716);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1423_13256 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1422, Current, 3, 1, 19717);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1422, Current, 19717);
...
body:;
	...
	RTHOOK(3);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10113, dtype))(Current)).it_p);
	up1 = tp1;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1422, Current, 0, 0, 19718);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1422, Current, 19718);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1423_13260_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1422, Current, 0, 0, 19719);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1422, Current, 19719);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1423_13260 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9342, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1423_13260_body (Current)).it_r;
