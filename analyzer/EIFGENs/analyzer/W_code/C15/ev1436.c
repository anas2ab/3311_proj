...
extern EIF_TYPED_VALUE F1436_13337(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1436_13337 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1435, Current, 0, 0, 19784);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1435, Current, 19784);
	RTIV(Current, RTAL);
	RTHOOK(1);
