...
extern EIF_TYPED_VALUE F1438_13353(EIF_REFERENCE);
static EIF_TYPED_VALUE F1438_13354_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1438_13354(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1438_13353 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1437, Current, 0, 0, 19794);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1437, Current, 19794);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1438_13354_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1437, Current, 0, 0, 19795);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1437, Current, 19795);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1438_13354 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9374, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1438_13354_body (Current)).it_r;
