...
extern void F1441_13389(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1441_13390(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1441_13391(EIF_REFERENCE);
extern void F1441_13392(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1441_13393_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1441_13393(EIF_REFERENCE);
extern void EIF_Minit1441(void);
extern EIF_REFERENCE _A1242_334();
extern EIF_REFERENCE _A1242_335();
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1440, Current, 0, 1, 19815);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1440, Current, 19815);
	RTCC(arg1, 1440, l_feature_name, 1, RTWCT(9343, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1441_13389 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1440, Current, 3, 0, 19816);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1242_334, (EIF_POINTER)(0),8201, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1242_335, (EIF_POINTER)(0),8202, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(9864, dtype))(Current, up1x, ur1x, ur2x, ur3x);
	...
	ur1 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10172, dtype))(Current, ur1x);
	RTHOOK(12);
	ub1 = (EIF_BOOLEAN) 1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9356, dtype))(Current, ub1x);
	if (RTAL & CK_ENSURE) {
...
EIF_TYPED_VALUE F1441_13390 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1440, Current, 2, 0, 19817);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1441_13391 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1441_13392 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1440, Current, 1, 1, 19813);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10189, 0xF80000B9, 0); /* start_path */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(10189, dtype)) = (EIF_REFERENCE) tr1;
	...
	if (RTAL & CK_ENSURE) {
		...
		tr1 = *(EIF_REFERENCE *)(Current + RTWA(10189, dtype));
		if (RTEQ(tr1, arg1)) {
			RTCK;
		} else {
			RTCF;
...
static EIF_TYPED_VALUE F1441_13393_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1440, Current, 0, 0, 19814);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1441_13393 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9343, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1441_13393_body (Current)).it_r;
