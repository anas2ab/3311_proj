...
static EIF_TYPED_VALUE F1454_14965_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1454_14965(EIF_REFERENCE);
static EIF_TYPED_VALUE F1454_14966_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1454_14966(EIF_REFERENCE);
extern void F1454_14973(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1454_14974(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1454_14981(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1454_14982(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1454_14983(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1454_14984(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1454_14965_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1453, Current, 0, 0, 21567);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1453, Current, 21567);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1454_14965 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(12355,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(12355, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1454_14965_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(12355,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
...
static EIF_TYPED_VALUE F1454_14966_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1453, Current, 0, 0, 21568);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1453, Current, 21568);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1454_14966 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(12356,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(12356, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1454_14966_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(12356,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
...
void F1454_14973 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1453, Current, 1, 1, 21561);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1453, Current, 21561);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 12355, 0xF80000E5, 0); /* target_name */
...
void F1454_14974 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1453, Current, 0, 1, 21562);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1453, Current, 21562);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,817,0xFF01,0xFFF9,1,186,0,0,0xFF01,1030,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(12354, dtype, Dftype(Current));
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 12356, 0xF8000331, 0); /* target_data_function */
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(17, "twin", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	tr1 = RTCCL(tr1);
	RTAR(Current, tr1);
...
void F1454_14981 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1453, Current, 2, 1, 21563);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1453, Current, 21563);
	RTCC(arg1, 1453, l_feature_name, 1, eif_new_type(1344, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1454_14982 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1453, Current, 0, 0, 21564);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1453, Current, 21564);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(12373, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
RTOID (F1454_14983)
EIF_TYPED_VALUE F1454_14983 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1453, Current, 0, 0, 21565);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1453, Current, 21565);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	RTNHOOK(1,3);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15977, "pnd_targets", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
RTOID (F1454_14984)
EIF_TYPED_VALUE F1454_14984 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1453, Current, 0, 0, 21566);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1453, Current, 21566);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (14983,F1454_14983)
	RTOTS (14984,F1454_14984)
}
