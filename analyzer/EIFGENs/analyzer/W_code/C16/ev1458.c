...
extern void F1458_13688(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1458_13689(EIF_REFERENCE);
static EIF_TYPED_VALUE F1458_13690_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1458_13690(EIF_REFERENCE);
...
void F1458_13688 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1457, Current, 0, 1, 20055);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1457, Current, 20055);
	RTCC(arg1, 1457, l_feature_name, 1, RTWCT(9343, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1458_13689 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1457, Current, 0, 0, 20056);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1457, Current, 20056);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1458_13690_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1457, Current, 0, 0, 20057);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1457, Current, 20057);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1458_13690 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9343, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1458_13690_body (Current)).it_r;
