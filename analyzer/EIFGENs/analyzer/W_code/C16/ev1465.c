...
extern void F1465_13722(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1465_13723(EIF_REFERENCE);
static EIF_TYPED_VALUE F1465_13724_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1465_13724(EIF_REFERENCE);
...
void F1465_13722 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTCC(arg1, 1464, l_feature_name, 1, RTWCT(9374, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1465_13723 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1464, Current, 0, 0, 20090);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1465_13724_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1464, Current, 0, 0, 20091);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1465_13724 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9374, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1465_13724_body (Current)).it_r;
