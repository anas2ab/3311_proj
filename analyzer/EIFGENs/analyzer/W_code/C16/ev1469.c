...
static EIF_TYPED_VALUE F1469_13829_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1469_13829(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1469_13830(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1469_13831(EIF_REFERENCE);
extern void F1469_13832(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1469_13829_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1468, Current, 0, 0, 20160);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1468, Current, 20160);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1469_13829 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9342, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1469_13829_body (Current)).it_r;
...
void F1469_13832 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1468, Current, 0, 0, 20163);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1468, Current, 20163);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10459, 0x04000000, 1); /* is_disconnected_from_window_manager */
...
void F1469_13833 (EIF_REFERENCE Current)
{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10460, 0x04000000, 1); /* has_shadow */
