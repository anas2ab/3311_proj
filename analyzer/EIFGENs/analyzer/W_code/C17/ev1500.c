...
extern void F1500_14347(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1500_14348(EIF_REFERENCE);
static EIF_TYPED_VALUE F1500_14349_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1500_14349(EIF_REFERENCE);
...
void F1500_14347 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1499, Current, 0, 1, 20539);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1499, Current, 20539);
	RTCC(arg1, 1499, l_feature_name, 1, RTWCT(9342, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1500_14348 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1499, Current, 1, 0, 20540);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9337, 1498))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
static EIF_TYPED_VALUE F1500_14349_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1499, Current, 0, 0, 20541);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1500_14349 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9342, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1500_14349_body (Current)).it_r;
