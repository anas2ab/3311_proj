...
extern void F1537_14963(EIF_REFERENCE);
extern void F1537_14964(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1537_14965(EIF_REFERENCE);
static EIF_TYPED_VALUE F1537_14966_body(EIF_REFERENCE);
...
void F1537_14963 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1536, Current, 0, 0, 21085);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1536, Current, 21085);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10990, 0x04000000, 1); /* focus_on_press_disabled */
...
EIF_TYPED_VALUE F1537_14965 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
static EIF_TYPED_VALUE F1537_14966_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1536, Current, 0, 0, 21088);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1536, Current, 21088);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1537_14966 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9342, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1537_14966_body (Current)).it_r;
