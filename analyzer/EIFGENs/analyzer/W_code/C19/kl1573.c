...
extern void F1573_15660(EIF_REFERENCE);
extern void F1573_15661(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1573_15662(EIF_REFERENCE);
...
void F1573_15660 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1572, Current, 4, 0, 21702);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1572, Current, 21702);
	RTIV(Current, RTAL);
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1572, Current, 0, 0, 21703);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1573_15662 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1573_15662,21705,RTMS_EX_H("\012",1,10));
}

void EIF_Minit1573 (void)
{
	GTCX
	RTOTS (15662,F1573_15662)
}
