...
extern void F1579_15692(EIF_REFERENCE);
extern void F1579_15693(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1579_15694(EIF_REFERENCE);
...
void F1579_15692 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1578, Current, 4, 0, 21734);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1578, Current, 21734);
	RTIV(Current, RTAL);
...
void F1579_15693 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1578, Current, 0, 0, 21735);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1578, Current, 21735);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
EIF_TYPED_VALUE F1579_15694 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1579_15694,21737,RTMS_EX_H("\012",1,10));
}

void EIF_Minit1579 (void)
{
	GTCX
	RTOTS (15694,F1579_15694)
}
