...
extern EIF_TYPED_VALUE F1006_8669(EIF_REFERENCE);
static EIF_TYPED_VALUE F1006_8670_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1006_8670(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1006_8671(EIF_REFERENCE);
static EIF_TYPED_VALUE F1006_8672_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1006_8672(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1006_8673(EIF_REFERENCE);
static EIF_TYPED_VALUE F1006_8674_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1006_8674(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1006_8669 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1005, Current, 1, 0, 15009);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6457, 0xF800047F, 0); /* pointer_motion_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1006_8670_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1005, Current, 0, 0, 15010);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1006_8670 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6457, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1006_8670_body (Current)).it_r;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1005, Current, 1, 0, 15011);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6459, 0xF8000481, 0); /* pointer_button_press_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1006_8672_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1006_8672 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6459, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1006_8672_body (Current)).it_r;
...
EIF_TYPED_VALUE F1006_8673 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1005, Current, 1, 0, 15013);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6461, 0xF8000481, 0); /* pointer_double_press_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1006_8674_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1005, Current, 0, 0, 15014);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1006_8674 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6461, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1006_8674_body (Current)).it_r;
