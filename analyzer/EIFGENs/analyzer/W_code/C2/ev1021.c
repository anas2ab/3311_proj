...
static EIF_TYPED_VALUE F1021_8764_body(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6542, 0xF8000482, 0); /* dock_started_actions_internal */
		tr1 = RTLNSMART(RTWCT(6542, dtype, Dftype(Current)).id);
...
#define up1 up1x.it_p
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6543, 0xF8000482, 0); /* dock_ended_actions_internal */
...
static EIF_TYPED_VALUE F1021_8764_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1021_8764 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6543, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1021_8764_body (Current)).it_r;
