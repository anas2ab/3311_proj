...
static const EIF_TYPE_INDEX egt_1_994 [] = {0xFF01,248,993,0xFFFF};
...
static const EIF_TYPE_INDEX egt_13_994 [] = {0xFF01,1160,0xFFFF};
...
static const struct desc_info desc_994[] = {
	...
	{EIF_GENERIC(egt_13_994), 14935, 0xFFFFFFFF},
