...
extern EIF_TYPED_VALUE F1009_8699(EIF_REFERENCE);
...
RTOID (F1009_8699)
EIF_TYPED_VALUE F1009_8699 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1008, Current, 0, 0, 15021);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1008, Current, 15021);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
