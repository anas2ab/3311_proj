...
static const EIF_TYPE_INDEX egt_1_999 [] = {0xFF01,248,998,0xFFFF};
...
static const EIF_TYPE_INDEX egt_13_999 [] = {0xFF01,1233,0xFFFF};
static const EIF_TYPE_INDEX egt_14_999 [] = {0xFF01,1170,0xFFFF};
...
static const struct desc_info desc_999[] = {
	...
	{EIF_GENERIC(egt_13_999), 14962, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_999), 14963, 0xFFFFFFFF},
};
void Init999(void)
{
	IDSC(desc_999, 0, 998);
	IDSC(desc_999 + 1, 1, 998);
	IDSC(desc_999 + 32, 917, 998);
}
