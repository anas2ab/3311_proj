...
extern void F1616_16516(EIF_REFERENCE, int);
...
void F1616_10143 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1615, Current, 0, 0, 16686);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1615, Current, 0, 1, 16687);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1615, Current, 1, 2, 16688);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1615, Current, 1, 2, 16689);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1616_16516 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1615, Current, 0, 16515);
	RTSA(dtype);
	RTME(dtype, 0);
