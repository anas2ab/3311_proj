...
extern EIF_TYPED_VALUE F1651_18291(EIF_REFERENCE);
extern void F1651_18292(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1651_18291 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1651_18292 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1650, Current, 0, 0, 24932);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1650, Current, 24932);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14863, 0xF80006E5, 0); /* implementation */
