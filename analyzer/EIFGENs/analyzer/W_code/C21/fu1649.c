...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1648, Current, 0, 1, 17526);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1648, Current, 17526);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1648, Current, 1, 1, 17527);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1648, Current, 17527);
	RTCC(arg1, 1648, l_feature_name, 1, RTWCT(4633, dtype, Dftype(Current)), 0x06);
	uarg1 = (EIF_BOOLEAN) RTS_OU (arg1);
	uarg = uarg1;
	if (uarg) {
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1648, Current, 0, 0, 17528);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1648, Current, 17528);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_operands", EX_PRE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1648, Current, 0, 1, 17529);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1648, Current, 17529);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1648, Current, 0, 1, 17530);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1648, Current, 17530);
	RTCC(arg1, 1648, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1648, Current, 0, 1, 17531);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1648, Current, 17531);
...
void F1649_6506 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1648, Current, 1, 0, 17532);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1648, Current, 17532);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4635, 0x10000000, 0); /* last_result */
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1648, Current, 2, 1, 17533);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1648, Current, 17533);
	if (arg1) {
		{
...
#define arg10 arg10x.it_p
	...
	RTEAA(l_feature_name, 1648, Current, 0, 10, 17534);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1648, Current, 17534);
	RTIV(Current, RTAL);
