...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1631, Current, 1, 1, 16479);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 16479);
	{
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1631, Current, 1, 0, 16480);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 16480);
	RTIV(Current, RTAL);
	if (RTAL & CK_CHECK) {
		RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1631, Current, 0, 1, 16481);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 16481);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1631, Current, 0, 1, 16482);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 16482);
	RTCC(arg1, 1631, l_feature_name, 1, RTWCT(2375, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1631, Current, 0, 1, 16483);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 16483);
	RTCC(arg1, 1631, l_feature_name, 1, RTWCT(2375, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
void F1632_3686 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1631, Current, 0, 0, 16484);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 16484);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1631, Current, 1, 0, 16485);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 16485);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1631, Current, 3, 1, 16486);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 16486);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
