...
extern EIF_TYPED_VALUE F1652_18293(EIF_REFERENCE);
extern void F1652_18294(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1652_18293 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1652_18294 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1651, Current, 0, 0, 24934);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1651, Current, 24934);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14863, 0xF80006E6, 0); /* implementation */
