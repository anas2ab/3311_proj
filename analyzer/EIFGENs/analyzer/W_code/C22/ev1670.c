...
extern EIF_TYPED_VALUE F1670_18543(EIF_REFERENCE);
extern void F1670_18544(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1670_18543 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1670_18544 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1669, Current, 0, 0, 25184);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1669, Current, 25184);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14863, 0xF80006F6, 0); /* implementation */
