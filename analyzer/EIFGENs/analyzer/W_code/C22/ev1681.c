...
extern EIF_TYPED_VALUE F1681_18669(EIF_REFERENCE);
extern void F1681_18670(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1681_18669 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1681_18670 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1680, Current, 0, 0, 25313);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1680, Current, 25313);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14863, 0xF8000705, 0); /* implementation */
