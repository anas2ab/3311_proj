...
extern EIF_TYPED_VALUE F1694_18727(EIF_REFERENCE);
extern void F1694_18728(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1694_18727 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1694_18728 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1693, Current, 0, 0, 25369);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14863, 0xF800070E, 0); /* implementation */
	tr1 = RTLN(eif_new_type(2014, 0x01).id);
