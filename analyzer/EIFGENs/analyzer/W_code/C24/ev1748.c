...
extern void F1748_19566(EIF_REFERENCE);
static EIF_TYPED_VALUE F1748_19568_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1748_19568(EIF_REFERENCE);
...
void F1748_19566 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1747, Current, 0, 0, 25992);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1747, Current, 25992);
	RTIV(Current, RTAL);
...
static EIF_TYPED_VALUE F1748_19568_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1747, Current, 0, 0, 25993);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1747, Current, 25993);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1748_19568 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15741, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1748_19568_body (Current)).it_r;
