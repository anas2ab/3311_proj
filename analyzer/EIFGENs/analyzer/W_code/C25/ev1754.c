...
extern EIF_TYPED_VALUE F1754_19589(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1754_19589 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1753, Current, 0, 0, 26003);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1753, Current, 26003);
	RTIV(Current, RTAL);
	RTHOOK(1);
