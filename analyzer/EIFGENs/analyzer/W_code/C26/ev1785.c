...
extern EIF_TYPED_VALUE F1785_19947(EIF_REFERENCE);
extern void F1785_19952(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1785_19953(EIF_REFERENCE);
static EIF_TYPED_VALUE F1785_19954_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1785_19954(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1785_19947 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1784, Current, 1, 0, 26205);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1784, Current, 26205);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,270,0xFF01,1682,0xFFFF};
		EIF_TYPE typres0;
	...
	for (;;) {
		...
		RTNHOOK(5,2);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15153, "is_selected", tr2))(tr2)).it_b);
		if (tb2) {
			RTHOOK(6);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15740, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(6,1);
...
void F1785_19952 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16641, 0x04000000, 1); /* default_key_processing_disabled */
...
EIF_TYPED_VALUE F1785_19953 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
/* {EV_LIST_I}.interface */
static EIF_TYPED_VALUE F1785_19954_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1784, Current, 0, 0, 26208);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1784, Current, 26208);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1785_19954 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15741, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1785_19954_body (Current)).it_r;
