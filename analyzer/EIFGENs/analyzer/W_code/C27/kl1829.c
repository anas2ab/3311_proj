...
extern EIF_TYPED_VALUE F1829_20359(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1829_20359 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1828, Current, 0, 0, 26441);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1828, Current, 26441);
	RTIV(Current, RTAL);
	RTHOOK(1);
