...
extern EIF_TYPED_VALUE F1849_20779(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1849_20780(EIF_REFERENCE);
extern void F1849_20781(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1849_20779 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1849_20780 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1849_20781 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1848, Current, 0, 0, 26803);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1848, Current, 26803);
	RTIV(Current, RTAL);
