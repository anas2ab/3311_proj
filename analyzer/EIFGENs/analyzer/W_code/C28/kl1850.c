...
extern void F1850_20782(EIF_REFERENCE);
extern void F1850_20783(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1850_20784(EIF_REFERENCE);
...
void F1850_20782 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1849, Current, 5, 0, 26804);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1849, Current, 26804);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(17287, dtype)) = (EIF_BOOLEAN) loc5;
	if (RTAL & CK_ENSURE) {
		RTHOOK(26);
...
void F1850_20783 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1849, Current, 0, 0, 26805);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1849, Current, 26805);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
EIF_TYPED_VALUE F1850_20784 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1850_20784,26807,RTMS_EX_H("\015\012",2,3338));
}

void EIF_Minit1850 (void)
{
	GTCX
	RTOTS (20784,F1850_20784)
}
