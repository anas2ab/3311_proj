...
extern void F1851_20785(EIF_REFERENCE);
extern void F1851_20786(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1851_20787(EIF_REFERENCE);
...
void F1851_20785 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1850, Current, 4, 0, 26807);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1850, Current, 26807);
	RTIV(Current, RTAL);
...
void F1851_20786 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1850, Current, 0, 0, 26808);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1850, Current, 26808);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
EIF_TYPED_VALUE F1851_20787 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1851_20787,26810,RTMS_EX_H("\012",1,10));
}

void EIF_Minit1851 (void)
{
	GTCX
	RTOTS (20787,F1851_20787)
}
