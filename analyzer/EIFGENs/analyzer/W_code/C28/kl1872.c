...
extern EIF_TYPED_VALUE F1872_21115(EIF_REFERENCE);
...
RTOID (F1872_21115)
EIF_TYPED_VALUE F1872_21115 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F1872_21115);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1871, Current, 0, 0, 27090);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1871, Current, 27090);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
