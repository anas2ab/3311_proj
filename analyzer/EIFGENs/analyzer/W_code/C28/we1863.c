...
extern EIF_TYPED_VALUE F1863_20915(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1863_20915 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1862, Current, 0, 0, 26937);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1862, Current, 26937);
	RTIV(Current, RTAL);
	RTHOOK(1);
