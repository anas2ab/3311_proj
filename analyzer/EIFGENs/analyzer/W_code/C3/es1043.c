...
#define ub1 ub1x.it_b
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6798, 0xF8000330, 0); /* test_classes */
	tr1 = RTCCL(arg3);
	RTAR(Current, tr1);
	...
	for (;;) {
		...
		if (EIF_TEST(loc3)) {
			...
			for (;;) {
				...
				RTHOOK(16);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7191, "is_violation_case", loc4))(loc4)).it_b);
				if (tb3) {
					RTHOOK(17);
					tb3 = *(EIF_BOOLEAN *)(loc4 + RTVA(7194, "passed", loc4));
					if (tb3) {
						RTHOOK(18);
						RTDBGAA(Current, dtype, 6793, 0x10000000, 1); /* number_passed_violation */
