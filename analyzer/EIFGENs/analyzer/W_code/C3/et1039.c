...
extern void F1039_25650(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1038, Current, 0, 0, 16322);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1038, Current, 16322);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F1039_25650 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1038, Current, 0, 25649);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
