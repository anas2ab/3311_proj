...
static const EIF_TYPE_INDEX egt_14_1041 [] = {0xFF01,1611,0xFF01,0xFFF9,1,186,0xFF01,1171,0xFFFF};
...
static const struct desc_info desc_1041[] = {
	...
	{EIF_GENERIC(egt_13_1041), 15291, 0},
	{EIF_GENERIC(egt_14_1041), 15287, 8},
