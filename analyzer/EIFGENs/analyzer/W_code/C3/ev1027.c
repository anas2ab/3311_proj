...
extern void F1027_8845(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1027_8846(EIF_REFERENCE);
extern void F1027_8847(EIF_REFERENCE);
extern void F1027_8848(EIF_REFERENCE);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6620, 0x10000000, 1); /* scale_width */
...
void F1027_8845 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1026, Current, 0, 1, 15164);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6621, 0x10000000, 1); /* scale_height */
...
void F1027_8848 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1026, Current, 0, 0, 15167);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1026, Current, 15167);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
