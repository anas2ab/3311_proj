...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6628, 0xF8000482, 0); /* close_request_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6630, 0xF800047F, 0); /* move_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6632, 0xF8000482, 0); /* show_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6634, 0xF8000482, 0); /* hide_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
