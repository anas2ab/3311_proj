...
#define up1 up1x.it_p
	...
	RTCC(arg1, 1030, l_feature_name, 1, eif_new_type(1666, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7674, 0xF8000682, 0); /* pixmap */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7672, 0xF80005AD, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
