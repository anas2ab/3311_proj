...
static EIF_TYPED_VALUE F1053_9110_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1053_9110(EIF_REFERENCE);
extern void F1053_9111(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1052, Current, 1, 0, 15387);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		ur1 = RTCCL(Result);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6878, dtype))(Current, ur1x);
		RTHOOK(5);
		RTDBGAA(Current, dtype, 6877, 0xF800047C, 0); /* expose_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1053_9110_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1052, Current, 0, 0, 15388);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1053_9110 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6877, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1053_9110_body (Current)).it_r;
...
void F1053_9111 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTCC(arg1, 1052, l_feature_name, 1, RTWCT(6876, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
