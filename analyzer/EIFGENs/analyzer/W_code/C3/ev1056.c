...
static EIF_TYPED_VALUE F1056_9184_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1056_9184(EIF_REFERENCE);
extern void F1056_9185(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1055, Current, 1, 0, 15462);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 15462);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		ur1 = RTCCL(Result);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6951, dtype))(Current, ur1x);
		RTHOOK(5);
		RTDBGAA(Current, dtype, 6950, 0xF8000485, 0); /* expose_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1056_9184_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1055, Current, 0, 0, 15463);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 15463);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1056_9184 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6950, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1056_9184_body (Current)).it_r;
...
void F1056_9185 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1055, Current, 0, 1, 15464);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 15464);
	RTCC(arg1, 1055, l_feature_name, 1, RTWCT(6949, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
