...
extern EIF_TYPED_VALUE F1057_10167(EIF_REFERENCE);
...
RTOID (F1057_10167)
EIF_TYPED_VALUE F1057_10167 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1056, Current, 0, 0, 16513);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1056, Current, 16513);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
