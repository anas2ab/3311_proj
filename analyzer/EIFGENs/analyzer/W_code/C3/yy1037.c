...
extern void F1037_16473(EIF_REFERENCE, int);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(6749, dtype)) = (EIF_BOOLEAN) tb1;
	...
	RTHOOK(9);
	RTDBGAA(Current, dtype, 6748, 0xF80004CB, 0); /* file */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F1037_16473 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1036, Current, 0, 16472);
	RTSA(dtype);
	RTME(dtype, 0);
