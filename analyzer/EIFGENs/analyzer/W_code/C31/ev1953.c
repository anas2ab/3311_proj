...
extern EIF_TYPED_VALUE F1953_23315(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1953_23316(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1953_23315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1952, Current, 0, 0, 29255);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1952, Current, 29255);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1953_23316 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1952, Current, 0, 0, 29256);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1952, Current, 29256);
	RTIV(Current, RTAL);
	RTHOOK(1);
