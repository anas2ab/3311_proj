...
extern void F2006_25031(EIF_REFERENCE);
extern void F2006_25032(EIF_REFERENCE);
extern void F2006_25033(EIF_REFERENCE);
extern void F2006_25034(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2006_25035(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2006_25036(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F2006_25037(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2006_25038(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2006_25039(EIF_REFERENCE);
extern void F2006_25040(EIF_REFERENCE);
extern void F2006_25041(EIF_REFERENCE);
extern void F2006_25042(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2006_25043(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F2006_25044_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2006_25044(EIF_REFERENCE);
...
void F2006_25031 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 2005, Current, 0, 0, 30881);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30881);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F2006_25032 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2005, Current, 2, 0, 30882);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30882);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	...
	if (tb1) {
		...
		if (EIF_TEST(loc1)) {
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(19911, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (((EIF_INTEGER_32) 20L) + (EIF_INTEGER_32) (ti4_1 / ((EIF_INTEGER_32) 2L)));
		} else {
			RTHOOK(4);
			...
			if (EIF_TEST(loc2)) {
				RTHOOK(5);
				RTDBGAA(Current, dtype, 19911, 0x10000000, 1); /* extra_width */
				ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(17843, "height", loc2))(loc2)).it_i4);
				*(EIF_INTEGER_32 *)(Current + RTWA(19911, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (((EIF_INTEGER_32) 20L) + (EIF_INTEGER_32) (ti4_1 / ((EIF_INTEGER_32) 2L)));
			} else {
				if (RTAL & CK_CHECK) {
					RTHOOK(6);
	...
	RTHOOK(7);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(19529, 2004))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(8);
	RTDBGLE;
...
void F2006_25033 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2005, Current, 2, 0, 30883);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30883);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(loc2 != NULL)) {
		...
		for (;;) {
			...
			RTNHOOK(6,1);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(19168, "set_unchecked", tr1))(tr1);
			RTHOOK(7);
...
void F2006_25034 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2005, Current, 0, 0, 30884);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30884);
	RTIV(Current, RTAL);
...
RTOID (F2006_25035)
EIF_TYPED_VALUE F2006_25035 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F2006_25035);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 2005, Current, 0, 0, 30885);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30885);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F2006_25036 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 2005, Current, 2, 3, 30886);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30886);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16298, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc2 = RTCCL(tr1);
...
void F2006_25037 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 2005, Current, 0, 1, 30887);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30887);
	RTIV(Current, RTAL);
	RTHOOK(1);
	switch (arg1) {
		case 39L:
		case 40L:
			RTHOOK(2);
			ub1 = (EIF_BOOLEAN) 1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(19925, dtype))(Current, ub1x);
			break;
		case 37L:
		case 38L:
			RTHOOK(3);
		...
		default:
			RTHOOK(4);
			ui4_1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(19562, 2004))(Current, ui4_1x);
			break;
	}
	RTVI(Current, RTAL);
	RTRS;
...
void F2006_25038 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 2005, Current, 4, 1, 30888);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30888);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(4, 0xF80007C0, 0, 0); /* loc4 */
	...
	if ((EIF_BOOLEAN)(loc4 != NULL)) {
		...
		up2 = tp2;
		ub1 = arg1;
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(19924, dtype))(Current, up1x, up2x, ub1x)).it_p);
	...
	if ((EIF_BOOLEAN)(loc1 != loc2)) {
		...
		if ((EIF_BOOLEAN)(loc3 != NULL)) {
			RTHOOK(7);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(18538, "set_focus", loc3))(loc3);
		}
	}
	RTVI(Current, RTAL);
	RTRS;
...
EIF_TYPED_VALUE F2006_25039 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2005, Current, 0, 0, 30889);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30889);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
...
void F2006_25040 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2005, Current, 1, 0, 30890);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30890);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F2006_25041 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2005, Current, 0, 0, 30891);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30891);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F2006_25042 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2005, Current, 0, 1, 30892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30892);
	RTCC(arg1, 2005, l_feature_name, 1, eif_new_type(1615, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	tr1 = RTCCL(tr2);
	*(EIF_REFERENCE *)(Current + RTWA(19531, dtype)) = RTRV(RTWCT(19531, dtype, Dftype(Current)), tr1);
	RTAR(Current, tr1);
	RTHOOK(3);
...
void F2006_25043 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2005, Current, 0, 2, 30893);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30893);
	RTCC(arg1, 2005, l_feature_name, 1, eif_new_type(1471, 0x01), 0x01);
	RTCC(arg2, 2005, l_feature_name, 2, eif_new_type(1565, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
static EIF_TYPED_VALUE F2006_25044_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2005, Current, 0, 0, 30894);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2005, Current, 30894);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F2006_25044 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15741, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F2006_25044_body (Current)).it_r;
