...
extern EIF_TYPED_VALUE F2054_11625(EIF_REFERENCE);
extern void F2054_11626(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {COMPOSITE}.children */
EIF_TYPED_VALUE F2054_11625 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {COMPOSITE}.add_child */
void F2054_11626 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2053, Current, 0, 1, 17946);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2053, Current, 17946);
	RTCC(arg1, 2053, l_feature_name, 1, RTWCT(9404, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
