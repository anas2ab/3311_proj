...
extern EIF_TYPED_VALUE F2048_19312(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2048_19313(EIF_REFERENCE);
extern void F2048_19314(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F2048_19315(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F2048_19312 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2047, Current, 2, 1, 25803);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2047, Current, 25803);
	RTIV(Current, RTAL);
...
body:;
	...
	if (EIF_TEST(loc1)) {
		...
		loc2 = RTCCL(tr1);
		loc2 = RTRV(RTWCT(16072, dtype, Dftype(Current)),loc2);
		tb1 = EIF_TEST(loc2);
	}
	if (tb1) {
		RTCK0;
...
EIF_TYPED_VALUE F2048_19313 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2047, Current, 0, 0, 25800);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2047, Current, 25800);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F2048_19314 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2047, Current, 1, 2, 25801);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2047, Current, 25801);
	RTCC(arg1, 2047, l_feature_name, 1, RTWCT(16072, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
...
void F2048_19315 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2047, Current, 0, 1, 25802);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2047, Current, 25802);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
