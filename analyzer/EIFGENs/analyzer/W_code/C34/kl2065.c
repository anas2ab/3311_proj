...
extern EIF_TYPED_VALUE F2065_11518(EIF_REFERENCE);
extern void F2065_11519(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2065_11520(EIF_REFERENCE);
...
/* {KL_LINKABLE}.right */
EIF_TYPED_VALUE F2065_11518 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F2065_11519 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2064, Current, 0, 1, 17844);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2064, Current, 17844);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 9295, 0xF8000810, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F2065_11520 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2064, Current, 0, 0, 17845);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2064, Current, 17845);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9295, 0xF8000810, 0); /* right */
