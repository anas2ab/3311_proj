...
extern void F1085_9396(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ETF_ENUM_PARAM}.make */
void F1085_9396 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1084, Current, 0, 1, 15651);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7127, 0xF800014C, 0); /* items */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1084, Current, 1, 0, 15654);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1084, Current, 1, 0, 15655);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
