...
extern void F1088_9417(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ETF_ENUM_PARAM}.make */
void F1088_9417 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7157, 0xF800014C, 0); /* items */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F1088_9419 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1087, Current, 0, 0, 15674);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1087, Current, 1, 0, 15675);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1087, Current, 1, 0, 15676);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
