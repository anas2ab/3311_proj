...
static const EIF_TYPE_INDEX egt_17_1107 [] = {0xFF01,274,0xFF01,0xFFF9,0,186,0xFFFF};
...
static const struct desc_info desc_1107[] = {
	...
	{EIF_GENERIC(egt_13_1107), 1317, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_14_1107), 15742, 0},
	{EIF_GENERIC(egt_15_1107), 15743, 8},
	{EIF_GENERIC(egt_16_1107), 15744, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 15745, 36},
	{EIF_GENERIC(egt_17_1107), 15746, 24},
};
void Init1107(void)
{
	IDSC(desc_1107, 0, 1106);
	IDSC(desc_1107 + 1, 1, 1106);
	IDSC(desc_1107 + 32, 193, 1106);
