...
extern void F1105_9474(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1105_9475(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1105_9476(EIF_REFERENCE);
extern void F1105_9477(EIF_REFERENCE);
extern void F1105_9478(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1105_9474 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1104, Current, 1, 0, 15728);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1104, Current, 15728);
	RTIV(Current, RTAL);
	wstdinit(loc1,loc1);
	RTLXI(loc1);
	RTHOOK(1);
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7185, 0xF80003D6, 0); /* model */
...
void F1105_9477 (EIF_REFERENCE Current)
{
	GTCX
...
void F1105_9478 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1104, Current, 1, 1, 15732);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
