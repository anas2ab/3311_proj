...
extern EIF_TYPED_VALUE F1112_10736(EIF_REFERENCE);
...
RTOID (F1112_10736)
EIF_TYPED_VALUE F1112_10736 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1111, Current, 0, 0, 17063);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1111, Current, 17063);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
