...
extern EIF_TYPED_VALUE F1127_11028(EIF_REFERENCE);
static EIF_TYPED_VALUE F1127_11029_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1127_11029(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1127_11028 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1126, Current, 1, 0, 17347);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1126, Current, 17347);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 8805, 0xF8000546, 0); /* new_item_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1127_11029_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1126, Current, 0, 0, 17348);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1126, Current, 17348);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1127_11029 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(8805, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1127_11029_body (Current)).it_r;
