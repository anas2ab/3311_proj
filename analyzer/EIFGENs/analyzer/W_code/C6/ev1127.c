...
extern EIF_TYPED_VALUE F1127_9950(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1126, Current, 0, 0, 16184);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tr1 = RTLN(eif_new_type(1332, 0x00).id);
	...
	RTNHOOK(1,1);
	ur1 = RTCCL(tr2);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7602, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr2);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1126, Current, 0, 0, 16185);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1126, Current, 0, 0, 16186);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1126, Current, 0, 0, 16187);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(11090, "set_from_xpm_data", loc1))(loc1, up1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1126, Current, 1, 0, 16189);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1126, Current, 1, 0, 16190);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(4);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7609, dtype))(Current)).it_p);
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(11090, "set_from_xpm_data", loc1))(loc1, up1x);
	RTVI(Current, RTAL);
	RTRS;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1126, Current, 1, 0, 16191);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(4);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7610, dtype))(Current)).it_p);
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(11090, "set_from_xpm_data", loc1))(loc1, up1x);
	RTVI(Current, RTAL);
	RTRS;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1126, Current, 1, 0, 16192);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(10994, "set_with_default", loc1))(loc1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
	RTDBGLE;
...
EIF_TYPED_VALUE F1127_9950 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1126, Current, 3, 1, 16193);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1126, Current, 16193);
	RTCC(arg1, 1126, l_feature_name, 1, eif_new_type(1236, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc3) {
		...
		up1 = tp1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9483, "set_from_stock_id", loc2))(loc2, up1x);
	} else {
		RTHOOK(7);
		RTDBGAL(0, 0xF80004FD, 0,0); /* Result */
		tr1 = RTLN(eif_new_type(1277, 0x01).id);
