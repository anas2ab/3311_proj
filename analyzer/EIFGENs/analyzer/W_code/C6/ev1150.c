...
extern void F1150_10162(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1150_10163(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1150_10164(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1150(void);
extern EIF_REFERENCE _A1150_184_2_3_4_5_6_7_8();
...
void F1150_10162 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1149, Current, 0, 1, 16712);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFFF9,2,186,0xFF01,0,0xFF01,275,0xFF01,0xFFF9,0,186,0xFFFF};
		EIF_TYPE typres0;
		typarr0[4] = dftype;
	...
	*((EIF_INTEGER_32 *)tr3+6) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 8L);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,275,0xFF01,0xFFF9,7,186,218,218,206,206,206,218,218,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1150_184_2_3_4_5_6_7_8, (EIF_POINTER)(0),7754, tr2, 0, 1, -1, tr1, 7);
	}
	ur1 = RTCCL(tr4);
...
void F1150_10163 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x, EIF_TYPED_VALUE arg6x, EIF_TYPED_VALUE arg7x, EIF_TYPED_VALUE arg8x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1149, Current, 0, 8, 16713);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1149, Current, 16713);
	{
		...
		RTCC(arg8, 1149, l_feature_name, 8, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
...
EIF_TYPED_VALUE F1150_10164 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1149, Current, 0, 1, 16714);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1149, Current, 16714);
	RTIV(Current, RTAL);
