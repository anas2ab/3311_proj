...
extern void F1140_10099(EIF_REFERENCE);
extern void F1140_16514(EIF_REFERENCE, int);
...
/* {ROOT}.add_tests */
void F1140_10099 (EIF_REFERENCE Current)
{
	GTCX
...
/* {ROOT}._invariant */
void F1140_16514 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1139, Current, 0, 16513);
	RTSA(dtype);
	RTME(dtype, 0);
