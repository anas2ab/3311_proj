...
extern void F1180_10369(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1180_10369 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1179, Current, 0, 1, 16931);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1179, Current, 16931);
	RTIV(Current, RTAL);
	RTHOOK(1);
