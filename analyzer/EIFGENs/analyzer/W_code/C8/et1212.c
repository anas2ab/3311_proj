...
extern void F1212_10440(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1212_10440 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1211, Current, 0, 1, 16989);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1211, Current, 16989);
	RTIV(Current, RTAL);
	RTHOOK(1);
