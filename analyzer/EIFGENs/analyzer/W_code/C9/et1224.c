...
extern void F1224_10463(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1224_10463 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1223, Current, 0, 1, 17006);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1223, Current, 17006);
...
body:;
	...
	RTNHOOK(3,1);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(6329, "add_class", tr1))(tr1, ur1x);
	RTHOOK(4);
