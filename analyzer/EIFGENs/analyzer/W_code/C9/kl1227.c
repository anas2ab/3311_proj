...
extern EIF_TYPED_VALUE F1227_10514(EIF_REFERENCE);
...
RTOID (F1227_10514)
EIF_TYPED_VALUE F1227_10514 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1226, Current, 0, 0, 17109);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1226, Current, 17109);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
