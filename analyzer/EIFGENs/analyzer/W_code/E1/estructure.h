...
struct eif_ex_348 {union overhead overhead; char data [8];};
struct eif_ex_430 {union overhead overhead; char data [8];};
struct eif_ex_449 {union overhead overhead; char data [8];};
struct eif_ex_468 {union overhead overhead; char data [8];};
struct eif_ex_472 {union overhead overhead; char data [8];};
struct eif_ex_476 {union overhead overhead; char data [8];};
struct eif_ex_542 {union overhead overhead; char data [8];};
struct eif_ex_547 {union overhead overhead; char data [8];};
struct eif_ex_551 {union overhead overhead; char data [8];};
struct eif_ex_813 {union overhead overhead; char data [8];};
struct eif_ex_820 {union overhead overhead; char data [8];};
struct eif_ex_825 {union overhead overhead; char data [8];};
struct eif_ex_981 {union overhead overhead; char data [1];};
